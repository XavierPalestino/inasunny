insert into products (name) values ("Arte"), ("Drama");

insert into sale (title, pages, isbn, price, summary, editorial, release_date, deleted) values
...
insert into user(name, first_name, second_name, birthday) values
  ("user-1", "fn-1", "sn-1", "1950-10-06"),
  ("user-2", "fn-2", "sn-2", "1960-11-07"),
  ("user-3", "fn-3", "sn-3", "1970-12-08"),
  ("user-4", "fn-4", "sn-4", "1980-01-09"),
  ("user-5", "fn-5", "sn-5", "1990-02-10"),
  ("user-6", "fn-6", "sn-6", "1940-03-11");
